...
<head>
    ...
    <style>
        ...
        /* Statistics Section için özel fix */
        .statistics-area .container {
            overflow-x: visible;
        }

        /* İçerik Alanı Sol Boşluk - Sadece Slider Hariç */
        .about-area,
        .statistics-area,
        .blog-area,
        .footer-area {
        ...
        /* Sol Menü Overflow ve Height Fix */
        .header-layout-left {
            height: 100vh;
            overflow-y: auto;
            overflow-x: hidden;
        ...
        /* 1200-1500px arası genişlik için sosyal medya icon fix */
        ...
        /* Küçük yükseklik için özel ayarlar - Sadece Desktop (XL) */
        ...
        .carousel-control-next-icon {
            ...
            .carousel-control-prev-icon::after {
                background-image: url('assets/img/icons/prev-icon.png'); /* Kendi ikonunuzun yolunu ekleyin */
            }

            .carousel-control-next-icon::after {
                background-image: url('assets/img/icons/next-icon.png'); /* Kendi ikonunuzun yolunu ekleyin */
            }
        ...
        .social-icons {
            ...
            .social-icons a {
                display: inline-block;
                font-size: 34px; /* İkonların boyutunu ayarlamak için */
                color: #333; /* İkonların varsayılan rengini ayarlayabilirsin */
                transition: color 0.3s ease;
            }

                .social-icons a:hover {
                    color: #0077b5; /* İkon üzerine gelindiğinde rengini değiştirebilirsin */
                }

        /* 1500px+ ekranlar için daha rahat spacing */
        ...
        .fa-linkedin {
            color: #0077b5; /* LinkedIn ikonu için mavi */
            font-size: 24px;
        }

        .fa-instagram {
            color: #e4405f; /* Instagram ikonu için kırmızı/pembe */
            font-size: 24px;
        }

        .fa-github {
            color: white; /* GitHub ikonu için koyu gri */
            font-size: 24px;
        }

        /* Başvur Butonu Stilleri */
        .carousel-caption {
            position: absolute;
            bottom: 20%;
            left: 50%;
        ...
        /* ============================================
           YENİ İSTATİSTİK BÖLÜMÜ CSS BAŞLANGIÇ
        ============================================ */

        /* Statistics Section Styles - Minimalist */
        .statistics-area {
            background: #ffffff;
            position: relative;
            overflow: hidden;
            ...
            .statistics-area .tp-section__sub-title {
                color: #6c757d;
                font-weight: 400;
                font-size: 13px;
            }

            .statistics-area .tp-section__title {
                color: #2c3e50;
                font-weight: 600;
                font-size: 22px;
            }
        ...
        /* ============================================
           YENİ İSTATİSTİK BÖLÜMÜ CSS BİTİŞ
        ============================================ */
    </style>
...
<!-- Sadece bu blok için stil -->
<style>
  /* Yeni dar, pill form buton (teal → aqua degrade) */
  .btn-panel{
  ...
  .btn-panel:hover{ color:#fff; filter:brightness(1.05); transform:translateY(-1px); }
  .social-icons a{ margin-right:10px; }

  /* XL ve üstü: sosyal ikonların ALTINDA, dar ve sola hizalı */
  @media (min-width:1200px){
    .menu-login-wrapper{
      margin-top:12px;
      display:flex; justify-content:flex-start;
    }
    .header-left-menu .menu-login-wrapper .btn-panel{
      width:auto; /* artık tam genişlik değil */
      padding:10px 16px; /* daraltıldı */
    }
  }
</style>
...
<div class="layout-left-right">
        ...
        <div class="header-left-menu">
          <nav id="mobile-menu">
            <ul>
              ...
              <!-- Sosyal medya ikonları + ALTINA dar “Üye Giriş” -->
              <li>
                ...
                <div class="menu-login-wrapper">
                  <a href="panel/login" class="btn-panel">
                    <i class="fas fa-user-lock"></i> Üye Giriş
                  </a>
                </div>
              </li>
            </ul>
  ...
  <!-- MOBİL HEADER (XL altı) – değişmedi -->
  ...
  <div class="content-layout-right">
   ...
   <!-- hero-area-end -->
            <!-- ============================================
                 YENİ İSTATİSTİK BÖLÜMÜ BAŞLANGIÇ
            ============================================ -->
            <!-- statistics-area -->
                        ...
                        <div class="col-xl-6 col-lg-6 col-12">
                            <div class="tp-about__content mb-50 wow fadeInLeft" data-wow-delay=".3s">
                                <div class="tp-section">
                                    ...
                                    <a href="#"> <i></i></a>
                                    <p class=" mr-20 mb-45">Erciyes Üniversitesi Yapay Zeka Kulübü, yüksek kalitede yapay zeka bilimi üreten Erciyes Üniversitesi Bilgisayar Mühendisliği bünyesinde, Yapay Zeka Anabilim Dalı Başkanı ve yapay zeka alanında yaptığı özgün çalışmalar ile Türkiye Bilimler Akademisi ödüllü Prof. Dr. Bahriye Akay danışmanlığında kuruldu. Yapay zeka teknolojilerinin alt sistemlerinde gerçekleştirilecek araştırmalarla, geleceğin teknolojilerine yön vermek ve inovasyonu teşvik etmek bu alanda eğitimler ve ödüllü yarışmalar düzenlemeyi hedeflemekteyiz. Araştırma grubumuzda yürütülen ve yürütülecek projeler, teknolojide sürdürülebilir bir değişim sağlama amacını taşır. Amacımız, lisans düzeyinde bilimsel içerik üreterek, teknolojik gelişmelerin önünü açmak ve bu alanda lider bir topluluk olmaktır.</p>
                                </div>
            ...
            <section class="blog-area tp-common-area grey-bg pt-125 pb-100" data-background="assets/img/shape/shape-bg-09.png">
                <div class="container">
                    ...
                    <?php
                    // Aktif etkinlikleri getir (maksimum 3 tane)
                    $aktif_etkinlikler = get_aktif_etkinlikler(3);
                    ?>
                                ...
                                <div class="row">
                                    <div class="col-xxl-6 col-xl-7 col-lg-6 col-md-12 col-12">
                                        <div class="footer-widget__copyright cpy-white-content">
                                            <span> © Copyright ©2024 <a href="index.html">Erciyes Üniversitesi Yapay Zeka Kulübü</a>. <i>All Rights Reserved Copyright</i></span>
