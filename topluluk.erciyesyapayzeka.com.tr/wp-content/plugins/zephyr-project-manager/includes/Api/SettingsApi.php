...
class SettingsApi {
	...
	public function add_admin_menu() {
		...
		foreach ($this->admin_pages as $page) {
			...
			if ($title === 'Zephyr Project Manager') {
				$title = __('Zephyr Project Manager', 'zephyr-project-manager');
			}
			
			if ($menuTitle === 'Zephyr Project Manager') {
				$menuTitle = __('Zephyr Project Manager', 'zephyr-project-manager');
			}

			add_menu_page($title, $menuTitle, $page['capability'], $page['menu_slug'], $page['callback'], $page['icon_url'], $page['position']);
		}
