...
$strings = array(
	...
	'created' => __('Created', 'zephyr-project-manager'),
	...
	/* translators: Message indicating no projects created and prompting the user to create one. %1$s: Opening anchor tag for project creation, %2$s: Closing anchor tag */
	'no_projects_created' => sprintf(esc_html('No projects created yet. To create a project, click on the \'Add\' button at the top right of the screen or click %1$s here %2$s', 'zephyr-project-manager'), '<a id="zpm_first_project" class="zpm_button_link">', '</a>'),
	...
	/* translators: Confirmation message for deleting tasks. %s: Number of tasks */
	'delete_tasks_confirmation' => __('Are you sure that you would like to delete %s tasks?', 'zephyr-project-manager'),
	'automatically_update_dates' => __('Automatically update start and due dates', 'zephyr-project-manager'),
	'link_copied' => __('Link copied to clipboard.', 'zephyr-project-manager'),
	'button_text' => array(
