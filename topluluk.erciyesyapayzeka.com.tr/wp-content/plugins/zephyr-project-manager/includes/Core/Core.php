...
class Core {
	...
	public function projectCompleted( $project ) {
		...
		/* translators: Project completion notification. %s: Project name */
		...
		foreach ($managers as $manager) {
			Emails::send_email( $manager['email'], $subject, $html, 'project_completed');
		}
	}
	...
	public function projectAssigned( $project, $assignees ) {
		...
		/* translators: Project assignment notification. %s: Project name */
		...
		foreach ($assignees as $assignee) {
			if (isset($assignee['email'])) {
				...
				Emails::send_email( $assignee['email'], $subject, $html, 'project_assigned');
				$sent[] = $assignee['email'];
			}
		}
	}
