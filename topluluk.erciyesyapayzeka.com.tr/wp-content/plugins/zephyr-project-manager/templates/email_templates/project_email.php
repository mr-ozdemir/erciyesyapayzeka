...
<body>
	<div id="zpm_email_container">
		<div id="zpm_email_title">
			<h2 class="zpm_email_header"><?php esc_html_e('Weekly Progress Update', 'zephyr-project-manager'); ?></h2>
		</div>

		<div id="zpm_email_body">
			<span class="task_item">
				<div class="task_count"><?php echo esc_html($project_count); ?></div>
				<div class="task_subject"><?php esc_html_e('Projects', 'zephyr-project-manager'); ?></div>
			</span>
			<span class="task_item">
				<div class="task_count"><?php echo esc_html($completed_projects); ?></div>
				<div class="task_subject"><?php esc_html_e('Completed Projects', 'zephyr-project-manager'); ?></div>
			</span>
			<span class="task_item">
				<div class="task_count"><?php echo esc_html($pending_projects); ?></div>
				<div class="task_subject"><?php esc_html_e('Pending Projects', 'zephyr-project-manager'); ?></div>
			</span>
		</div>

		<div id="zpm_email_footer">
			<a href="" class="zpm_email_link">
				<button id="zpm_action_button"><?php esc_html_e('View Projects', 'zephyr-project-manager'); ?></button>
			</a>
		</div>
	</div>

	<div id="zpm_after_email">
		<a class="zpm_after_email_link" href=""><?php esc_html_e('View Projects in WordPress', 'zephyr-project-manager'); ?></a> |
		<a class="zpm_after_email_link" href=""><?php esc_html_e('Unfollow', 'zephyr-project-manager'); ?></a>
	</div>
</body>
