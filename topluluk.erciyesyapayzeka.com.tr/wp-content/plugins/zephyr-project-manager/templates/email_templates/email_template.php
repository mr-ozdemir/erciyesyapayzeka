...
<html>
	<head>
	    <style>
			...
			<?php echo apply_filters('zpm/email/css', $css); ?>
	    </style>
	</head>
    <body style="background: #f4f4f4; padding: 50px;">
		<div id="zpm_email_container" style="background: #fff; height: max-content; min-height: none;">
			...
			<?php do_action('zpm/email/header'); ?>
			...
			<div id="zpm_email_body" style="padding-bottom: 100px !important; padding: 50px; height: max-content; min-height: none;">
				...
				<?php echo $body ?>
				<?php do_action('zpm/email/body'); ?>
			</div>

			<div id="zpm_email_footer" style="padding: 20px;">
				<?php echo $footer; ?>
				<?php do_action('zpm/email/footer'); ?>
			</div>
		</div>

		<div id="zpm_after_email" style="text-align: center;">
			<a class="zpm_after_email_link" href="<?php echo esc_url(admin_url('/admin.php?page=zephyr_project_manager_settings')); ?>"><?php esc_html_e( 'Unfollow', 'zephyr-project-manager' ); ?></a>
		</div>
	</body>
</html>