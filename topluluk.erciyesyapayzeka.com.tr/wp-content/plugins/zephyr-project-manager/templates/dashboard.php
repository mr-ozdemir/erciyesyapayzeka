...
// ]);
?>
<!-- <button data-print-project-pdf-button="42" data-text="<?php esc_html_e('Print', 'zephyr-project-manager') ?>" data-loading-text="<?php esc_html_e('Printing...', 'zephyr-project-manager') ?>">Print</button> -->
	...
	<?php if (!apply_filters('zpm_hide_zephyr', false)) : ?>
		...
		<?php else : ?>
			...
			<div id="zpm_container">
				<h1 class="zpm_page_title"><?php esc_html_e('Dashboard', 'zephyr-project-manager'); ?></h1>
				<div class="zpm_panel_container">
						...
						<div class="zpm-grid-row zpm-grid-row-12">
							<div class="zpm-grid-item zpm-grid-item-3">
								<div class="zpm-material-card zpm-material-card-colored zpm-card-color-blue">
									<h4 class="zpm-card-header"><?php esc_html_e('Projects Overview', 'zephyr-project-manager'); ?></h4>
									<div class="zpm-stat-list-item">
										...
										<?php esc_html_e('Projects', 'zephyr-project-manager'); ?>
									</div>
									<div class="zpm-stat-list-item">
										<span data-zpm-stat="projects_completed" class="zpm-stat-value"><?php echo esc_html($completed_projects); ?></span>
										<?php esc_html_e('Completed Projects', 'zephyr-project-manager'); ?>
									</div>
									<div class="zpm-stat-list-item">
					...
					<div class="zpm-panel zpm-panel-8">
						...
						<h4 class="zpm_panel_title"><?php esc_html_e('Overview', 'zephyr-project-manager'); ?></h4>
						...
						<div id="zpm-project-stat-overview">
							<span class="zpm-project-stat">
								...
								<a class="zpm_button zpm_button_inverted zpm-dashboard__button" href="<?php echo esc_url($projectsUrl); ?>"><?php esc_html_e('View All', 'zephyr-project-manager') ?></a>
							</span>
							<span class="zpm-project-stat">
								<span class="zpm-project-stat-value good"><?php echo esc_html($completed_projects); ?></span>
								<span class="zpm-project-stat-label"><?php esc_html_e('Completed Projects', 'zephyr-project-manager'); ?></span>
								<a class="zpm_button zpm_button_inverted zpm-dashboard__button" href="<?php echo esc_url($projectsUrl); ?>&completed=true"><?php esc_html_e('View All', 'zephyr-project-manager') ?></a>
							</span>
							<span class="zpm-project-stat">
								...
								<a class="zpm_button zpm_button_inverted zpm-dashboard__button" href="<?php echo esc_url($tasksUrl); ?>&completed=true"><?php esc_html_e('View All', 'zephyr-project-manager') ?></a>
							</span>
						</div>
					</div>
					...
					<div class="zpm-panel zpm-panel-8">
						...
						<div id="zpm-project-stat-overview" class="zpm-user-overview-stats">
							<span class="zpm-project-stat">
								<span class="zpm-project-stat-value"><?php echo esc_html($userProjectCount); ?></span>
								<span class="zpm-project-stat-label"><?php esc_html_e('Projects', 'zephyr-project-manager'); ?></span>
								<a class="zpm_button zpm_button_inverted zpm-dashboard__button" href="<?php echo esc_url($projectsUrl); ?>&user=<?php echo esc_html($user_id); ?>&category_id=-1"><?php esc_html_e('View All', 'zephyr-project-manager') ?></a>
							</span>
							<span class="zpm-project-stat">
								...
								<a class="zpm_button zpm_button_inverted zpm-dashboard__button" href="<?php echo esc_url($tasksUrl); ?>&user=<?php echo esc_html($user_id); ?>"><?php esc_html_e('View All', 'zephyr-project-manager') ?></a>
							</span>
							<span class="zpm-project-stat">
								...
								<a class="zpm_button zpm_button_inverted zpm-dashboard__button" href="<?php echo esc_url($tasksUrl); ?>&user=<?php echo esc_html($user_id); ?>&status=pending"><?php esc_html_e('View All', 'zephyr-project-manager') ?></a>
							</span>
							<span class="zpm-project-stat">
								<span class="zpm-project-stat-value good"><?php echo sizeof($user_completed_tasks); ?></span>
								<span class="zpm-project-stat-label"><?php esc_html_e('Completed Tasks', 'zephyr-project-manager'); ?></span>
								<a class="zpm_button zpm_button_inverted zpm-dashboard__button" href="<?php echo esc_url($tasksUrl); ?>&user=<?php echo esc_html($user_id); ?>&completed=true"><?php esc_html_e('View All', 'zephyr-project-manager') ?></a>
							</span>
						</div>
					</div>
					...
					<?php if (sizeof($daily_tasks) > 0) : ?>
						<div class="zpm-panel zpm-panel-8">
							<h4 class="zpm_panel_title"><?php esc_html_e('Daily Tasks', 'zephyr-project-manager'); ?></h4>
						...
						<div class="<?php echo sizeof($dashboard_projects) > 1 ? 'zpm_panel_6' : 'zpm_panel_12'; ?> zpm_dashboard_project_container">
							<div class="zpm_panel zpm_chart_panel zpm_dashboard_project" data-project-id="<?php echo esc_attr($project->id); ?>">
								...
								<?php if (!empty($due_date)): ?>
									<div class="zpm-project-grid__date zpm-mt-2"><?php esc_html_e('Due Date', 'zephyr-project-manager') ?>: <?php echo esc_html($due_date); ?></div>
								<?php endif; ?>

								<div class="zpm-dashboard-project--actions">
									<a class="zpm-btn zpm_button zpm-mt-2" href="<?php echo esc_url($url) ?>" target="_BLANK"><?php esc_html_e('View Project', 'zephyr-project-manager') ?></a>
								</div>
					...
					if (empty($dashboard_projects) || $i == 0) {
						...
						<div class="zpm_no_results_message">
							<?php /* translators: Dashboard welcome message with instructions. %1$s: Opening anchor tag with project URL, %2$s: Closing anchor tag, %3$s: Opening <i> tag for styling, %4$s: Closing </i> tag */ ?>
							<?php printf(esc_html('Welcome to the Dashboard. To add projects to the dashboard and keep track of important projects, navigate to the %1$s Projects %2$s page and click on the options button for the project, then select the option %3$s Add to Dashboard %4$s.', 'zephyr-project-manager'), '<a href="' . esc_url($project_url) . '" class="zpm_link">', '</a>', '<i>', '</i>'); ?>
						</div>
					<?php
					}
					?>
					...
					<!-- <?php if (!Utillities::notice_is_dismissed('zpm-patreon-notice')) : ?>
						<div id="zpm-whats-new" class="zpm-panel zpm-panel-12" data-notice="'zpm-patreon-notice'">
							<h4 class="zpm_panel_title"><?php esc_html_e('Support me on Patreon', 'zephyr-project-manager'); ?></h4>
							<p><?php esc_html_e('If you like the plugin and what I do and would like to help me improve the plugin more, please consider supporting me on Patreon. This would help a lot in being able to work on the plugin full-time and focus more on it to make it better and add new features. Thank you so much.', 'zephyr-project-manager'); ?></p>
							<div class="zpm-notice-buttons">
								
								<button class="zpm-dismiss-notice-button zpm_button" data-notice-version="zpm-patreon-notice"><?php esc_html_e('Dismiss Notice', 'zephyr-project-manager'); ?></button>
								<a href="https://www.patreon.com/dylanjkotze" target="_blank" class="zpm-patreon-button zpm_button"><?php esc_html_e('Support me on Patreon', 'zephyr-project-manager'); ?></a>
							</div>
						</div>
					<?php endif; ?> -->
