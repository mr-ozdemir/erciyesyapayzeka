...
<div class="zpm_settings_wrap">
	...
	<div id="zpm_container" class="zpm_custom_fields">
		<h3 class="zpm-info-title"><?php esc_html_e( 'Extensions', 'zephyr-project-manager' ); ?> <small class="zpm-heading-subtext">- <?php esc_html_e( 'Zephyr Project Manager add-ons to increase productivity and integrate with your favourite tools', 'zephyr-project-manager' ); ?></small></h3>
				...
				<div class="zpm-extension" style="background-color: <?php echo esc_attr($extension['color']); ?>;">
					...
					<?php if (!$extension['installed']) : ?>
						...
						<div class="zpm-buttons__float-right">
							<a href="<?php echo esc_url($extension['link']); ?>" class="zpm_button zpm-button__white" style="color: <?php echo esc_attr($extension['color']); ?> !important;"><?php esc_html_e( 'Get Now', 'zephyr-project-manager' ); ?></a>
						</div>
					<?php else: ?>
						<p class="zpm-extension__description zpm-extension__installed"><i class="fa fa-check"></i><?php esc_html_e( 'Installed', 'zephyr-project-manager' ); ?></p>
					<?php endif; ?>
				</div>
			<?php endforeach; ?>
		</div>
