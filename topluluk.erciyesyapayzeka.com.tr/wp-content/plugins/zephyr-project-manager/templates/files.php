...
<main id="zpm_file_page" class="zpm_settings_wrap">
	...
	<div id="zpm_container">
		<h1 class="zpm_page_title"><?php esc_html_e( 'Files', 'zephyr-project-manager' ); ?></h1>
		<?php if (Utillities::canUploadFiles()) : ?>
			<button data-task-id="no-task" id="zpm_upload_file_btn" class="zpm_task_chat_files zpm_button"><?php esc_html_e( 'Upload Files', 'zephyr-project-manager' ); ?></button>
		<?php endif; ?>
		<div class="zpm_body">
			<div class="zpm_side_navigation">
				<ul>
					<li data-project-id="-1" class="zpm_filter_file zpm_selected_link"><?php esc_html_e( 'All Files', 'zephyr-project-manager' ); ?></li>
			...
			<div class="zpm_files_container">
				...
				<?php endforeach; ?>
				<p id="zpm_no_files" class="zpm_error_message" style="display: none;"><?php esc_html_e( 'No Files', 'zephyr-project-manager' ); ?></p>
			</div>
		</div>
	</div>
</main>
