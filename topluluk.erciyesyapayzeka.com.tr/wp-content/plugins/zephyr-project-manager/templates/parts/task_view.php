...
<div class="zpm_modal_body">
	...
	<nav class="zpm_nav">
		<ul class="zpm_nav_list">
			<li class="zpm_nav_item zpm_nav_item_selected" data-zpm-tab="task-overview"><?php esc_html_e('Overview', 'zephyr-project-manager'); ?></li>
			<li class="zpm_nav_item" data-zpm-tab="task-discussion"><?php esc_html_e('Discussion', 'zephyr-project-manager'); ?></li>
		</ul>
	</nav>
	...
	<div class="zpm_modal_content">
		<div class="zpm_tab_pane zpm_tab_active" data-zpm-tab="task-overview">
			...
			<span id="zpm_task_modal_assignee">
				<label class="zpm_label"><?php esc_html_e('Assigned To', 'zephyr-project-manager'); ?>:</label>
				...
				<?php else : ?>
					<p class="zpm-no-result-error"><?php esc_html_e('Not assigned to any members', 'zephyr-project-manager'); ?></p>
				<?php endif; ?>
			</span>

			<span id="zpm_task_modal_task_assignee">
				<label class="zpm_label"><?php esc_html_e('Assigned Team', 'zephyr-project-manager'); ?>:</label>

				<?php if ($team !== "" && !is_null($team)) : ?>
					<span class="zpm-task-view-team-name"><?php echo esc_html($team['name']); ?></span>
				<?php else : ?>
					<p class="zpm-no-result-error"><?php esc_html_e('Not assigned to any teams', 'zephyr-project-manager'); ?></p>
				<?php endif; ?>
			...
			<div id="zpm_view_task_subtasks">
				<label class="zpm_label"><?php esc_html_e('Subtasks', 'zephyr-project-manager'); ?></label>
				<ul class="zpm_view_subtasks">
					...
					<?php if (sizeof($subtasks) <= 0) : ?>
						<p class='zpm-no-result-error'><?php esc_html_e('No subtasks created.', 'zephyr-project-manager'); ?></p>
					<?php endif; ?>
				</ul>
	...
	<div class="zpm_modal_buttons">
		...
		<a class="zpm_button" href="<?php echo esc_url($tasks_url . '&action=view_task&task_id=' . $task_id); ?>" id="zpm_edit_task_link"><?php esc_html_e('Go to Task', 'zephyr-project-manager'); ?></a>
	</div>
</div>