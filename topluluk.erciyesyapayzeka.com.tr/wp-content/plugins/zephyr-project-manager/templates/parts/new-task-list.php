...
<div id="zpm-new-task-list-modal" class="zpm-modal zpm-form" role="dialog" aria-labelledby="zpm-new-task-list-button" aria-modal="true" aria-hidden="true">
	<h5 class="zpm_modal_header"><?php esc_html_e( 'New Task List', 'zephyr-project-manager' ); ?></h5>
	<div class="zpm_modal_body">
		<div class="zpm_modal_content">
			...
			<div>
				<div class="zpm-new-task-field__assignee">
					...
					<select id="zpm-task-list-assignees" class="zpm-chosen zpm-chosen-input" multiple data-placeholder="<?php esc_html_e( 'Select Assignees', 'zephyr-project-manager' ); ?>">
				...
				<div class="zpm-new-task-field__project">
					...
					<select id="zpm-task-list-project" class="zpm-chosen zpm-chosen-input" data-placeholder="<?php esc_html_e( 'Select Project', 'zephyr-project-manager' ); ?>">
		...
		<div class="zpm_modal_buttons">
			<button id="zpm-create-task-list" type="submit" class="zpm_button" data-create-task-list><?php esc_html_e( 'Create Task', 'zephyr-project-manager' ); ?></button>
		</div>
	</div>
</div>
