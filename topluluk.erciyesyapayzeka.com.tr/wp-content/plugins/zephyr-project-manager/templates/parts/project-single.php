...
?>
	<div class="zpm-notice"><?php esc_html_e('Sorry, you do not have access to this project.', 'zephyr-project-manager'); ?></div>
<?php
	return;
}
...
$tasks = Tasks::sortByDueDate($tasks, true);
$tasks = Projects::getOrderedTasks($project->id, $tasks);
$canEditProject = Utillities::can_edit_projects();
$teams = Members::get_teams();
$start_date = zpm_date($project->date_start, __('Not Set', 'zephyr-project-manager'), 'Y-m-d');
$due_date = zpm_date($project->date_due, __('Not Set', 'zephyr-project-manager'), 'Y-m-d');
...
<div class="zpm-breadcrumbs">
	<a href="<?php echo esc_url(Utillities::getProjectsURL()); ?>"><?php esc_html_e('Projects', 'zephyr-project-manager'); ?></a>
	<span class="zpm-breadcrumb-separator">/</span>
	<a href="#"><?php echo esc_html($project->name); ?></a>
</div>

<h2 id="zpm_project_name_title" class="zpm_admin_page_title">
	<?php echo esc_html($project->name); ?>
	<?php if ($general_settings['display_project_id'] == '1') : ?>
		<?php $uniqueID = Projects::get_unique_id($project->id); ?>
		<?php if (!str_contains($project->name, '(#' . $uniqueID . ')')): ?>
			(#<?php echo esc_html($uniqueID); ?>)
		<?php endif; ?>
...
<span id="zpm_switch_project_type_button" class="zpm_circle_text_btn zpm-tooltip-parent" data-project-type="<?php echo $project->type == 'list' ? 'board' : 'list'; ?>" data-project-id="<?php echo esc_attr($project->id); ?>" data-zpm-pro="<?php echo Zephyr::isPro(); ?>" aria-haspopup="true">
	<span class="zpm-project-type__label">
		<?php esc_html_e('Type: ', 'zephyr-project-manager'); ?>
		<?php switch ($project->type) {
			case 'list':
				esc_html_e('List', 'zephyr-project-manager');
				break;
			case 'board':
				esc_html_e('Kanban (Board)', 'zephyr-project-manager');
				break;
			case 'gantt':
				esc_html_e('Gantt (Timeline)', 'zephyr-project-manager');
				break;
			case 'scrum':
				esc_html_e('SCRUM', 'zephyr-project-manager');
				break;
			default:
				esc_html_e('List', 'zephyr-project-manager');
				break;
	...
	<div class="zpm-dropdown__extended zpm-dropdown">
		<div class="zpm-dropdown-item zpm-switch-project-type" data-type="list" data-project-id="<?php echo esc_attr($project->id); ?>" data-zpm-pro="<?php echo Zephyr::isPro(); ?>">
			<p class="zpm-dropdown-item__title"><?php esc_html_e('List', 'zephyr-project-manager'); ?></p>
			<p class="zpm-dropdown-item__sub"><?php esc_html_e('Organize your work in an itemized list.', 'zephyr-project-manager'); ?></p>
		</div>
		<div class="zpm-dropdown-item zpm-switch-project-type <?php echo !Zephyr::isPro() ? 'zpm-pro-required-item' : ''; ?>" data-type="board" data-project-id="<?php echo esc_attr($project->id); ?>" data-zpm-pro="<?php echo Zephyr::isPro(); ?>">
			<p class="zpm-dropdown-item__title"><?php esc_html_e('Kanban (Board)', 'zephyr-project-manager'); ?>
				<?php echo Zephyr::proRequiredLabel(); ?>
			</p>
			<p class="zpm-dropdown-item__sub"><?php esc_html_e('Organize your work like sticky notes on a board.', 'zephyr-project-manager'); ?></p>
		</div>
		<!-- Add to next version -->
		<div class="zpm-dropdown-item zpm-switch-project-type <?php echo !Zephyr::isPro() ? 'zpm-pro-required-item' : ''; ?>" data-type="gantt" data-project-id="<?php echo esc_attr($project->id); ?>" data-zpm-pro="<?php echo Zephyr::isPro(); ?>">
			<p class="zpm-dropdown-item__title"><?php esc_html_e('Gantt (Timeline)', 'zephyr-project-manager'); ?>
				<?php echo Zephyr::proRequiredLabel(); ?>
			</p>
			<p class="zpm-dropdown-item__sub"><?php esc_html_e('Organize your work with a visual Gantt timeline chart.', 'zephyr-project-manager'); ?></p>
		</div>
		<!-- Add to next version -->
		<div class="zpm-dropdown-item zpm-switch-project-type <?php echo !Zephyr::isPro() ? 'zpm-pro-required-item' : ''; ?>" data-type="scrum" data-project-id="<?php echo esc_attr($project->id); ?>" data-zpm-pro="<?php echo Zephyr::isPro(); ?>">
			<p class="zpm-dropdown-item__title"><?php esc_html_e('SCRUM', 'zephyr-project-manager'); ?>
				<?php echo Zephyr::proRequiredLabel(); ?>
			</p>
			<p class="zpm-dropdown-item__sub"><?php esc_html_e('Manage your project using SCRUM principles.', 'zephyr-project-manager'); ?></p>
		</div>
	</div>
</span>
...
<div class="zpm_nav_holder zpm_body">
	<nav class="zpm_nav">
		<ul class="zpm_nav_list">
			<li id="zpm-project-tab--overview" class="zpm_nav_item <?php echo $defaultTab == 'overview' ? 'zpm_nav_item_selected' : ''; ?>" data-zpm-tab="project-overview" role="tab" aria-selected="true"><?php esc_html_e('Overview', 'zephyr-project-manager'); ?></li>
			...
			<li id="zpm-project-tab--discussion" class="zpm_nav_item <?php echo $defaultTab == 'discussion' ? 'zpm_nav_item_selected' : ''; ?>" data-zpm-tab="project-discussion" role="tab" aria-selected="false"><?php esc_html_e('Discussion', 'zephyr-project-manager'); ?></li>
			<li id="zpm-project-tab--members" class="zpm_nav_item <?php echo $defaultTab == 'members' ? 'zpm_nav_item_selected' : ''; ?>" data-zpm-tab="project-members" role="tab" aria-selected="false"><?php esc_html_e('Members', 'zephyr-project-manager'); ?></li>
			<li id="zpm-project-tab--progress" class="zpm_nav_item <?php echo $defaultTab == 'progress' ? 'zpm_nav_item_selected' : ''; ?>" id="zpm_update_project_progress" data-zpm-tab="project-progress" role="tab" aria-selected="false"><?php esc_html_e('Progress', 'zephyr-project-manager'); ?></li>
			<?php echo apply_filters('zpm-project-tabs', '', $project->id); ?>
			<li id="zpm-project-tab--settings" class="zpm_nav_item <?php echo $defaultTab == 'settings' ? 'zpm_nav_item_selected' : ''; ?>" data-zpm-tab="project-settings" role="tab" aria-selected="false"><?php esc_html_e('Settings', 'zephyr-project-manager'); ?></li>
		</ul>
	</nav>
</div>
...
<div id="zpm_project_editor" class="zpm_body <?php echo 'project-type-' . esc_attr($project->type); ?>" data-project-id="<?php echo esc_attr($project->id); ?>">
	...
	<?php if ($canEditProject) : ?>
		<div id="zpm-project-tabpanel--overview" class="zpm_tab_pane zpm-form <?php echo $defaultTab == 'overview' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="project-overview" role="tabpanel">
			...
			<div class="zpm-form__group">
				<textarea id="zpm_edit_project_description" class="zpm-form__field zpm-auto-resize" placeholder="<?php echo !$isScrum ? __('Project Description', 'zephyr-project-manager') : __('Product Vision', 'zephyr-project-manager'); ?>"><?php echo esc_html(stripslashes($project->description)); ?></textarea>
			...
			<div class="zpm-form__group">
				<input type="text" name="zpm_edit_project_start_date" id="zpm_edit_project_start_date" data-original="<?php echo esc_attr(date('Y-m-d', strtotime($project->date_start))); ?>" class="zpm-form__field" placeholder="<?php esc_html_e('Start Date', 'zephyr-project-manager'); ?>" value="<?php echo zpm_date($project->date_start, '', 'Y-m-d'); ?>">
				<label for="zpm_edit_project_start_date" class="zpm-form__label"><?php esc_html_e('Start Date', 'zephyr-project-manager'); ?></label>
			</div>

			<div class="zpm-form__group">
				<input type="text" name="zpm_edit_project_due_date" id="zpm_edit_project_due_date" data-original="<?php echo esc_attr(date('Y-m-d', strtotime($project->date_due))); ?>" class="zpm-form__field" placeholder="<?php esc_html_e('Due Date', 'zephyr-project-manager'); ?>" value="<?php echo zpm_date($project->date_due, '', 'Y-m-d'); ?>">
				<label for="zpm_edit_project_due_date" class="zpm-form__label"><?php esc_html_e('Due Date', 'zephyr-project-manager'); ?></label>
			</div>
			...
			<?php if (Utillities::getSetting('task_blocking_enabled')) : ?>
				...
				<div class="zpm-project-field zpm-project-field__estimated-date zpm-mt-2">
					<label><?php esc_html_e('Estimated Date of Completion', 'zephyr-project-manager'); ?>:</label>
					<p data-project-estimated-end class="<?php echo $estimatedOverdue && !$isCompleted ? 'zpm-overdue-text' : ''; ?>"><?php echo esc_html(zpm_date($estimatedDate)); ?></p>
				</div>
			<?php endif; ?>

			<!-- Select Status -->
			<label class="zpm_label" for="zpm-edit-task__status"><?php esc_html_e('Status', 'zephyr-project-manager'); ?></label>
			<select id="zpm-edit-project__status" class="zpm_input zpm-select2" data-original="<?php echo esc_attr($projectStatus); ?>">
				<option value="-1"><?php esc_html_e('Select Status', 'zephyr-project-manager'); ?></option>
				<?php foreach ($statuses as $slug => $value) : ?>
					<option value="<?php echo esc_attr($slug); ?>" <?php echo isset($project_status['color']) && $slug == $project_status['color'] ? 'selected' : ''; ?>><?php echo esc_html($value['name']); ?></option>
				<?php endforeach; ?>
			</select>
			...
			<div class="zpm-edit-project__assignee-wrap">
				...
				<select id="zpm-edit-project__assignee" class="zpm_input zpm-input-chosen zpm-multi-select" multiple data-placeholder="<?php echo !$isScrum ? __('Select Project Managers', 'zephyr-project-manager') : __('Select Product Master', 'zephyr-project-manager'); ?>">
					<?php foreach ($members as $member) : ?>
						...
						<option <?php echo $selected; ?> value="<?php echo esc_attr($member['id']); ?>"><?php echo esc_html($member['name']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			...
			<div class="zpm_project_editor_categories">
				...
				<?php if (empty($categories)) : ?>
					...
					<p class="zpm_extra_info zpm_text_italic">
						<?php /* translators: Message indicating the absence of categories and prompting the user to create them. %1$s: Opening anchor tag with categories URL, %2$s: Closing anchor tag */ ?>
						<?php printf(esc_html('There are no categories yet. You can create categories %1$s here %2$s.', 'zephyr-project-manager'), '<a href="' . $categories_url . '" class="zpm_link">', '</a>'); ?></p>
				<?php else : ?>
			...
			<div class="zpm-hstack zpm-md-vstack zpm-gap-2 zpm-mt-2">
				<?php if (Utillities::can_edit_projects()) : ?>
					<button id="zpm_project_save_settings" class="zpm_button"><?php esc_html_e('Save Changes', 'zephyr-project-manager'); ?></button>
				<?php endif; ?>
				...
				<input type="hidden" id="zpm-edit-project-priority-value" value="<?php echo esc_attr($priority); ?>" />
				<span id="zpm-edit-project-priority" class="zpm_button zpm-priority-button zpm-priority-selection" zpm-toggle-dropdown="zpm-edit-project-priority-dropdown" data-priority="<?php echo esc_attr($priority); ?>" style="background: <?php echo esc_attr($status['color']); ?> !important; color: <?php echo $status['color'] !== '' ? '#fff !important' : ''; ?>">
					...
					<div id="zpm-edit-project-priority-dropdown" class="zpm-dropdown">
						<div class="zpm-dropdown-item zpm-edit-project-priority" data-value="priority_none" data-color="#f9f9f9"><span class="zpm-priority-indicator zpm-color-none"></span><?php esc_html_e('None', 'zephyr-project-manager'); ?></div>
						<?php foreach ($priorities as $slug => $priority) : ?>
							<div class="zpm-dropdown-item zpm-edit-project-priority" data-value="<?php echo esc_attr($slug); ?>" data-color="<?php echo esc_attr($priority['color']); ?>">
								<span class="zpm-priority-indicator <?php echo esc_attr($slug); ?>" style="background-color: <?php echo esc_attr($priority['color']); ?>"></span>
				...
				<div class="zpm_project_options">
					<span id="zpm-copy-project-shortcode" title="<?php esc_html_e('Copy Shortcode', 'zephyr-project-manager'); ?> [zephyr_project id='<?php echo esc_attr($project->id); ?>']" class="zpm_circle_option_btn" data-project-id="<?php echo esc_attr($project->id); ?>" data-shortcode="[zephyr_project id='<?php echo esc_attr($project->id); ?>']">
		...
		<div id="zpm-project-tabpanel--overview" class="zpm_tab_pane zpm-form <?php echo $defaultTab == 'overview' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="project-overview" role="tabpanel">
			...
			<div id="zpm-project-view" class="zpm-project-overview selected">
				...
				<div class="zpm-project-field zpm-project-field__start-date">
					<label><?php esc_html_e('Start Date', 'zephyr-project-manager'); ?>:</label>
					<p id="zpm-view-project-start"><?php echo esc_html($start_date); ?></p>
				</div>

				<div class="zpm-project-field zpm-project-field__due-date">
					<label><?php esc_html_e('Due Date', 'zephyr-project-manager'); ?>:</label>
					<p id="zpm-view-project-end"><?php echo esc_html($due_date); ?></p>
				</div>
				...
				<div class="zpm-project-field zpm-project-preview__field">
					<label><?php esc_html_e('Status', 'zephyr-project-manager'); ?>:</label>
					<p><span class="zpm-project-preview__status-color <?php echo esc_attr($status_color['color']); ?>"></span>
						<span id="zpm-project-preview-overview__status"><?php echo esc_html($status_color['status']); ?></span>
					</p>
				</div>

				<div class="zpm-project-field zpm-project-field__categories zpm-mb-2">
					<label><?php esc_html_e('Progress', 'zephyr-project-manager'); ?>:</label>
					<div><?php echo $percentComplete; ?>% <?php esc_html_e('Complete', 'zephyr-project-manager') ?></div>
				</div>

				<div class="zpm-project-field zpm-project-field__categories zpm-mb-2">
					<label><?php esc_html_e('Project Managers', 'zephyr-project-manager'); ?>:</label>
					<?php if (!empty($assigneeNames)) : ?>
						<div><?php echo esc_html(implode(', ', $assigneeNames)); ?></div>
					<?php else : ?>
				...
				<div class="zpm-project-field zpm-project-field__categories">
					<label><?php esc_html_e('Categories', 'zephyr-project-manager'); ?>:</label>
					<div id="zpm-view-categories">
						...
						<?php foreach ((array) $assigned_categories as $category) : ?>
							...
							<div class="zpm-category-view__item"><?php echo esc_html($category->name); ?></div>
							<?php $i++; ?>
						<?php endforeach; ?>
						<?php if ($i <= 0) : ?>
							<p class="zpm-no-categories"><?php esc_html_e('No categories assigned', 'zephyr-project-manager'); ?></p>
						<?php endif; ?>
					</div>
				</div>
	...
	<div id="zpm_project_view_discussion" class="zpm_tab_pane <?php echo $defaultTab == 'discussion' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="project-discussion" role="tabpanel">
		<h4 class="zpm_panel_heading"><?php esc_html_e('Comments', 'zephyr-project-manager'); ?></h4>
		...
		<div class="zpm_chat_box_section">
			<div class="zpm_chat_box">
				<div id="zpm_text_editor_wrap">
					<!-- <textarea id="zpm_chat_message" contenteditable="true" placeholder="<?php esc_html_e('Write comment...', 'zephyr-project-manager'); ?>"></textarea> -->
					<div id="zpm_chat_message" contenteditable="true" class="zpm-contenteditable" placeholder="<?php esc_html_e('Write comment...', 'zephyr-project-manager'); ?>"></div>
				...
				<div class="zpm_chat_box_footer">
					<?php if (Utillities::canUploadFiles()) : ?>
						<button data-project-id="<?php echo esc_attr($project->id); ?>" id="zpm_project_chat_files" class="zpm_task_chat_files zpm_button"><?php esc_html_e('Upload Files', 'zephyr-project-manager'); ?></button>
					<?php endif; ?>
					<button data-project-id="<?php echo esc_attr($project->id); ?>" id="zpm_project_chat_comment" class="zpm_button"><?php esc_html_e('Comment', 'zephyr-project-manager'); ?></button>
	...
	<div id="zpm-project-tabpanel--members" class="zpm_tab_pane <?php echo $defaultTab == 'members' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="project-members" role="tabpanel">
		<h4 class="zpm_panel_heading"><?php esc_html_e('Members', 'zephyr-project-manager'); ?></h4>
		<div>
			<ul class="zpm-member-list">
				<select id="zpm-edit-project__members" class="zpm_input zpm-input-chosen zpm-multi-select" multiple data-placeholder="<?php esc_html_e('Select Project Members', 'zephyr-project-manager'); ?>">
					<optgroup label="<?php esc_html_e('Members', 'zephyr-project-manager'); ?>">
						<?php foreach ($members as $member) : ?>
				...
				<div class="zpm-mt-2">
					<?php if (Utillities::can_edit_projects()) : ?>
						<button id="zpm-save-project-members" class="zpm_button"><?php esc_html_e('Save Members', 'zephyr-project-manager'); ?></button>
						<button id="zpm-select-all-project-members" data-zpm-action="select_all" class="zpm_button"><?php esc_html_e('Select All', 'zephyr-project-manager'); ?></button>
					<?php endif; ?>
				</div>
			</ul>
		</div>
	...
	<div id="zpm_project_view_progress" class="zpm_tab_pane <?php echo $defaultTab == 'progress' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="project-progress" role="tabpanel">
		<div id="zpm_project_view_status">
			<h4 class="zpm_panel_heading"><?php esc_html_e('Project Status', 'zephyr-project-manager'); ?></h4>
			...
			<?php if (Utillities::can_edit_projects()) : ?>
				<div id="zpm_project_overview_section">
					...
					<div id="zpm_project_status" class="zpm-contenteditable" placeholder="<?php esc_html_e('Project Status', 'zephyr-project-manager'); ?>" contentEditable="true">
						<?php echo esc_html($status_name); ?>
					</div>
					<div id="zpm_project_status_footer">
						<button id="zpm_update_project_status" class="zpm_button" data-project-id="<?php echo esc_attr($project->id); ?>"><?php esc_html_e('Update Status', 'zephyr-project-manager'); ?></button>
					</div>
				</div>
			<?php endif; ?>
		</div>
				...
				<div class="zpm-project-progress-member__item">
					<div class="zpm-project-progress__member" data-user-id="<?php echo esc_attr($member_id); ?>">
						...
						<div class="zpm-project-progress__member-details" data-user-id="<?php echo esc_attr($member_id); ?>">
							<?php esc_html_e('Loading...', 'zephyr-project-manager'); ?>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
		...
		<div id="zpm-chart-filter__container">
			<label class="zpm-label"><?php esc_html_e('Filter by member', 'zephyr-project-manager') ?>:</label>

			<select id="zpm-project-chart__filter">
				<option value="-1"><?php esc_html_e('All', 'zephyr-project-manager'); ?></option>
				<?php foreach ((array) $project_members as $member_id) : ?>
					<?php $member = Members::get_member($member_id); ?>
		...
		<!-- 		<h4 class="zpm_panel_heading"><?php esc_html_e('Progress', 'zephyr-project-manager'); ?></h4>
		...
		<div class='zpm_report_task_stats'>
			<span class='zpm_report_stat'>
				<label class='zpm_label'><?php esc_html_e('Completed Tasks', 'zephyr-project-manager'); ?></label> <?php echo esc_html($completed_tasks_count); ?>
			</span>
			<span class='zpm_report_stat'>
				<label class='zpm_label'><?php esc_html_e('Pending Tasks', 'zephyr-project-manager'); ?></label> <?php echo esc_html($pending_tasks); ?>
			</span>
			<span class='zpm_report_stat'>
				<label class='zpm_label'><?php esc_html_e('Overdue Tasks', 'zephyr-project-manager'); ?></label> <?php echo esc_html($overdue_tasks); ?>
			</span>
			<span class='zpm_report_stat'>
				<label class='zpm_label'><?php esc_html_e('Percent Complete', 'zephyr-project-manager'); ?>:</label> <?php echo esc_html(round($percent_complete)) . '%'; ?>
			</span>
		</div>
	</div>
	...
	<div id="zpm-project-single__settings" class="zpm_tab_pane <?php echo $defaultTab == 'settings' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="project-settings" role="tabpanel">
		<div>
			...
			<label class="zpm_label zpm_divider_label"><?php esc_html_e('My Notifications', 'zephyr-project-manager') ?></label>
			<form method="POST">
				<div>
				...
				<div>
					<label for="zpm-project-settings__task-completed-email" class="zpm-material-checkbox">
						...
						<span class="zpm-material-checkbox-label"><?php esc_html_e('Task Completed', 'zephyr-project-manager'); ?></span>
					</label>
				</div>
				...
				<div>
					<label for="zpm-project-settings__project-comments-email" class="zpm-material-checkbox">
						...
						<span class="zpm-material-checkbox-label"><?php esc_html_e('Project Comments', 'zephyr-project-manager'); ?></span>
					</label>
				</div>
				...
				<div>
					<label for="zpm-project-settings__task-comments-emails" class="zpm-material-checkbox">
						...
						<span class="zpm-material-checkbox-label"><?php esc_html_e('Task Comments', 'zephyr-project-manager'); ?></span>
					</label>
				</div>
				...
				<div>
					<label for="zpm-project-settings__task-assignee-comments-emails" class="zpm-material-checkbox">
						...
						<span class="zpm-material-checkbox-label"><?php esc_html_e('Assigned Task Comments', 'zephyr-project-manager'); ?></span>
					</label>
				</div>
				...
				<div>
					<label for="zpm-project-settings__subtasks-email" class="zpm-material-checkbox">
						...
						<span class="zpm-material-checkbox-label"><?php esc_html_e('New Subtasks', 'zephyr-project-manager'); ?></span>
					</label>
				</div>
				...
				<div>
					<label for="zpm-project-settings__weekly-update-email" class="zpm-material-checkbox">
						...
						<span class="zpm-material-checkbox-label"><?php esc_html_e('Weekly Update', 'zephyr-project-manager'); ?></span>
					</label>
				</div>

				<div>
					<label class="zpm_label"><?php esc_html_e('Additional Notification Emails (Comma Separated)', 'zephyr-project-manager'); ?></label>
					<input type="text" name="zpm-project-settings__additional-emails" id="zpm-project-settings__additional-emails" value="<?php echo !empty($additionalEmails) ? esc_attr(zpm_array_to_comma_string($additionalEmails)) : '';  ?>" placeholder="<?php esc_html_e('Additional Emails', 'zephyr-project-manager'); ?>" class="zpm_input" />
				</div>
				...
				<button id="zpm-project-single__save_settings" name="zpm-update-project-settings" class="zpm_button"><?php esc_html_e('Save Settings', 'zephyr-project-manager'); ?></button>
			</form>
		</div>
	</div>
