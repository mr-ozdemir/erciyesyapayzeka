...
$startDate = zpm_date($task->date_start, __('Not Set', 'zephyr-project-manager'), 'Y-m-d');
$dueDate = zpm_date($task->date_due, __('Not Set', 'zephyr-project-manager'), 'Y-m-d');
?>
...
<?php if (Utillities::canEditTask($task)) : ?>
	<div class="zpm-task-preview__section">
		...
		<p class="zpm-task-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e('About this task', 'zephyr-project-manager'); ?></p>
		<label class="zpm-task-preview__label" id="zpm-task-preview__section-information" class="zpm-task-preview__section-content"><?php esc_html_e('Name', 'zephyr-project-manager'); ?></label>
		...
		<label class="zpm-task-preview__label zpm-task-preview__section-content"><?php esc_html_e('Description', 'zephyr-project-manager'); ?></label>
		...
		<label class="zpm-task-preview__label zpm-task-preview__section-content"><?php esc_html_e('Assigned To', 'zephyr-project-manager'); ?></label>
		<p class="zpm-task-preview__label-value zpm-task-preview__assignee">
			<select id="zpm_edit_task_assignee" data-ajax-name="task_assignee" class="zpm_input zpm-input-chosen zpm-chosen" multiple data-placeholder="<?php esc_html_e('Select Assignees', 'zephyr-project-manager'); ?>">
		...
		<label class="zpm-task-preview__label zpm-task-preview__section-content"><?php esc_html_e('Start Date', 'zephyr-project-manager'); ?></label>
		<p class="zpm-task-preview__label-value zpm-task-preview__start-date">
			<input type="text" name="date_due" data-ajax-name="task_start_date" id="zpm-task-panel__date-due" class="zpm-form__field zpm-datepicker zpm_input" placeholder="<?php esc_html_e('Start Date', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($startDate); ?>">
		</p>

		<label class="zpm-task-preview__label zpm-task-preview__section-content"><?php esc_html_e('Due Date', 'zephyr-project-manager'); ?></label>
		<p class="zpm-task-preview__label-value zpm-task-preview__due-date">
			<input type="text" data-ajax-name="task_due_date" name="task_due_date" id="zpm-task-panel__date-start" class="zpm-form__field zpm-datepicker zpm_input" placeholder="<?php esc_html_e('Due Date', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($dueDate); ?>">
		</p>
		...
		<div class="zpm-task-preview__priority">
			<label class="zpm-task-preview__label zpm-task-preview__section-content"><?php esc_html_e('Priority', 'zephyr-project-manager'); ?></label>
		...
		<div class="zpm-task-preview__priority">
			<label class="zpm-task-preview__label zpm-task-preview__section-content"><?php esc_html_e('Status', 'zephyr-project-manager'); ?></label>
...
<?php if ($filesEnabled): ?>
	<div id="zpm-task-preview-section__files" class="zpm-task-preview__section">
		<p class="zpm-task-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e('Files', 'zephyr-project-manager'); ?></p>
...
<div class="zpm-task-preview__section">
	<p class="zpm-task-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e('Subtasks', 'zephyr-project-manager'); ?></p>
	<div id="zpm-task-preview__section-subtasks" class="zpm-task-preview__section-content">
		<div id="zpm-task-preview__subtasks" class="active">
			...
			<?php if (empty($subtasks)) : ?>
				<p class="zpm-notice__subtle"><?php esc_html_e('No subtasks', 'zephyr-project-manager'); ?></p>
			<?php endif; ?>
		</div>
	</div>
</div>
...
<div id="zpm-task-preview-section__discussion" class="zpm-task-preview__section">
	<p class="zpm-task-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e('Discussion', 'zephyr-project-manager'); ?></p>
	...
	<div class="zpm_chat_box_section">
		<div class="zpm_chat_box">
			<div id="zpm_text_editor_wrap">
				...
				<!-- <textarea id="zpm_chat_message" placeholder="<?php esc_html_e('Write comment...', 'zephyr-project-manager'); ?>"></textarea> -->

			</div>
			<div class="zpm_chat_box_footer">
				<button data-task-id="<?php echo esc_attr($task->id); ?>" id="zpm-submit-comment" class="zpm_button"><?php esc_html_e('Comment', 'zephyr-project-manager'); ?></button>
			</div>
		</div>
	</div>
</div>
