...
<div id="zpm_new_file_upload" class="zpm-modal" aria-hidden="true" role="dialog" aria-modal="true">
	<h3 class="zpm_modal_header"><?php esc_html_e('New Attachment', 'zephyr-project-manager'); ?></h3>
	...
	<div class="zpm_modal_footer">
		<button id="zpm_upload_file" class="zpm_button"><?php esc_html_e('Select File', 'zephyr-project-manager'); ?></button>
		<button id="zpm_submit_file" class="zpm_button"><?php esc_html_e('Upload Attachment', 'zephyr-project-manager'); ?></button>
	</div>
</div>
...
<div id="zpm-task-to-project-modal" class="zpm-modal" aria-modal="true" aria-hidden="true">
	<h3 class="zpm-modal-title"><?php esc_html_e('Copy to Project', 'zephyr-project-manager'); ?></h3>
	...
	<div class="zpm-modal-buttons">
		<button id="zpm-kanban-copy-task-to-project" class="zpm_button"><?php esc_html_e('Copy Task', 'zephyr-project-manager'); ?></button>
	</div>
</div>

<div id="zpm-column-to-project-modal" class="zpm-modal" aria-modal="true" aria-hidden="true">
	<h3 class="zpm-modal-title"><?php esc_html_e('Copy Column to Project', 'zephyr-project-manager'); ?></h3>
	...
	<div class="zpm-modal-buttons">
		<button id="zpm-kanban-column-to-project-btn" class="zpm_button"><?php esc_html_e('Copy Column', 'zephyr-project-manager'); ?></button>
	</div>
</div>
...
<template data-zpm-template="taskExportModal">
	<div data-task-export-options>
		<h3 class="zpm-modal-header"><?php esc_html_e('Export Tasks', 'zephyr-project-manager'); ?></h3>
		<div>
			<div class="zpm-checkbox-group">
				<input type="checkbox" data-export-names />
				<label><?php esc_html_e('Export names instead of IDs', 'zephyr-project-manager'); ?></label>
			</div>
			<div class="zpm-task-export-options-dates">
				<div>
					<label><?php esc_html_e('From', 'zephyr-project-manager'); ?></label>
					<input type="date" data-from />
				</div>
				<div>
					<label><?php esc_html_e('To', 'zephyr-project-manager'); ?></label>
					<input type="date" data-to />
				</div>
			</div>

			<h4><?php esc_html_e('Columns to Export', 'zephyr-project-manager'); ?></h4>
		...
		<div class="zpm-modal-footer">
			<button data-submit-task-export-button class="zpm_button"><?php esc_html_e('Export', 'zephyr-project-manager'); ?></button>
		</div>
	</div>
</template>
