...
<?php if (Utillities::canEditProject($project)) : ?>
	<div class="zpm-project-preview__section">
		<input type="hidden" data-ajax-name="project_id" value="<?php echo esc_attr($project->id); ?>" />
		<input type="hidden" data-ajax-name="frontend" value="true" />
		
		<p class="zpm-project-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e( 'About this project', 'zephyr-project-manager' ); ?></p>
		<label class="zpm-project-preview__label" id="zpm-project-preview__section-information" class="zpm-project-preview__section-content"><?php esc_html_e( 'Name', 'zephyr-project-manager' ); ?></label>
		...
		<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Description', 'zephyr-project-manager' ); ?></label>
		...
		<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Start Date', 'zephyr-project-manager' ); ?></label>
		<p class="zpm-project-preview__label-value zpm-project-preview__start-date">
			<input type="text" name="start_date" data-ajax-name="project_start_date" id="zpm-task-panel__date-due" class="zpm-form__field zpm-datepicker" placeholder="<?php esc_html_e( 'Start Date', 'zephyr-project-manager' ); ?>" value="<?php echo esc_attr($edit_start_date); ?>">
		</p>

		<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Due Date', 'zephyr-project-manager' ); ?></label>
		<p class="zpm-project-preview__label-value zpm-project-preview__due-date">
			<input type="text" name="date_due" data-ajax-name="project_due_date" id="zpm-project-panel__date-due" class="zpm-form__field zpm-datepicker" placeholder="<?php esc_html_e( 'Due Date', 'zephyr-project-manager' ); ?>" value="<?php echo esc_attr($edit_due_date); ?>">
		</p>
		...
		<div id="zpm-project-preview__status-section">
			<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Status', 'zephyr-project-manager' ); ?></label>
			<div id="zpm-project-panel-status-container">
				<select id="zpm-project-panel-status" class="zpm_input zpm-chosen" data-ajax-name="status">
		...
		<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Categories', 'zephyr-project-manager' ); ?></label>
		<p class="zpm-project-preview__label-value zpm-project-preview__categories">
			<select class="zpm_input zpm-chosen" data-ajax-name="project_categories" multiple data-placeholder="<?php esc_html_e( 'Select Categories', 'zephyr-project-manager' ); ?>">
				<?php foreach ($categories as $category) : ?>
					<option value="<?php echo esc_attr($category->id); ?>" <?php echo in_array($category->id, $assigned_categories) ? 'selected' : ''; ?>><?php echo esc_html($category->name); ?></option>
				<?php endforeach; ?>
			</select>
		</p>
	</div>
<?php else: ?>
	<div class="zpm-project-preview__section">
		...
		<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Description', 'zephyr-project-manager' ); ?></label>
		<p class="zpm-project-preview__label-value zpm-project-preview__description">
			<?php echo zpm_esc_html( $project->description ); ?>
		</p>

		<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Start Date', 'zephyr-project-manager' ); ?></label>
		<p class="zpm-project-preview__label-value zpm-project-preview__start-date">
			<?php echo esc_html(Tasks::formatDate($project->date_start)); ?>
		</p>

		<label class="zpm-project-preview__label zpm-project-preview__section-content"><?php esc_html_e( 'Due Date', 'zephyr-project-manager' ); ?></label>
		<p class="zpm-project-preview__label-value zpm-project-preview__due-date">
			<?php echo esc_html(Tasks::formatDate($project->date_due)); ?>
		</p>
...
<?php if ($filesEnabled): ?>
	<div id="zpm-project-preview-section__files" class="zpm-project-preview__section">
		<p class="zpm-project-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e( 'Files', 'zephyr-project-manager' ); ?></p>
		<div id="zpm-project-preview__section-files" class="zpm-project-preview__section-content">
			<div id="zpm-project-preview__files">
				<?php foreach ($attachments as $attachment) : ?>
					...
					<?php echo zpm_esc_html($file->html()); ?>
				<?php endforeach; ?>
				<?php if (empty($attachments)) : ?>
					<p class="zpm-notice__subtle"><?php esc_html_e( 'No files', 'zephyr-project-manager' ); ?></p>
				<?php endif; ?>
			</div>
		</div>
	</div>
...
<div class="zpm-project-preview__section">
	<p class="zpm-project-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e( 'Active Tasks', 'zephyr-project-manager' ); ?></p>
		...
		<div id="zpm-project-preview__tasks" class="zpm-active">
			<?php foreach ($tasks as $task) : ?>
				...
				<div class="zpm-project-preview__task">
					<label for="zpm-task-id-<?php echo esc_attr($task->id); ?>" class="zpm-material-checkbox">
						<input type="checkbox" id="zpm-task-id-<?php echo esc_attr($task->id); ?>" name="zpm-task-id-<?php echo esc_attr($task->id); ?>" class="zpm_task_mark_complete zpm_toggle invisible" value="1" <?php echo esc_attr($atts); ?> data-task-id="<?php echo esc_attr($task->id); ?>">
						<span class="zpm-material-checkbox-label"></span>
					</label>
					<a href="<?php echo esc_url($url); ?>"><?php echo esc_html($task->name); ?></a></div>
			<?php endforeach; ?>
			<?php if (empty($tasks)) : ?>
...
<div id="zpm-project-preview-section__discussion" class="zpm-project-preview__section">
	<p class="zpm-project-preview__section-title" style="color: <?php echo esc_attr($secondaryColor); ?>"><?php esc_html_e( 'Discussion', 'zephyr-project-manager' ); ?></p>
	<div id="zpm-project-preview__section-comments" class="zpm-project-preview__section-content">
		<div class="zpm_task_comments">
			<?php foreach($comments as $comment) : ?>
				...
				<?php echo zpm_esc_html($message->html()); ?>
			<?php endforeach; ?>
		</div>
	</div>
	<div class="zpm_chat_box_section">
		<div class="zpm_chat_box">
			<div id="zpm_text_editor_wrap">
				<!-- <textarea id="zpm_chat_message" placeholder="<?php esc_html_e( 'Write comment...', 'zephyr-project-manager' ); ?>" class="zpm-panel__no-update"></textarea> -->
				<div id="zpm_chat_message" class="zpm-contenteditable" contenteditable="true" placeholder="<?php esc_html_e( 'Write comment...', 'zephyr-project-manager' ); ?>" class="zpm-panel__no-update"></div>
			...
			<div class="zpm_chat_box_footer">
				...
				<button data-project-id="<?php echo esc_attr($projectId); ?>" id="zpm_project_chat_comment" class="zpm_button"><?php esc_html_e( 'Comment', 'zephyr-project-manager' ); ?></button>
			</div>
		</div>
	</div>
</div>