	...
	<div class="zpm_modal_body">
		...
		<div class="zpm_modal_actions">
			<nav class="zpm_nav">
				<ul class="zpm_nav_list">
					<li class="zpm_nav_item zpm_nav_item_selected" data-zpm-tab="1"><?php esc_html_e( 'Overview', 'zephyr-project-manager' ); ?></li>
					<li class="zpm_nav_item" data-zpm-tab="2"><?php esc_html_e( 'Tasks', 'zephyr-project-manager' ); ?></li>
					<li class="zpm_nav_item" data-zpm-tab="3"><?php esc_html_e( 'Discussion', 'zephyr-project-manager' ); ?></li>
				</ul>
			</nav>
		</div>
		...
		<div class="zpm_tab_pane" data-zpm-tab="2" id="zpm_tasks_tab">
			<?php if (Utillities::can_create_tasks()): ?>
				<button id="zpm_quick_task_add" class="zpm_button_outline"><?php esc_html_e( 'Add Task', 'zephyr-project-manager' ); ?></button>
			<?php endif; ?>
			<div class="zpm_quicktask_container">
				<div class="zpm_quicktask_content">
					<input id="zpm_quicktask_name" class="zpm_input" type="text" placeholder="<?php esc_html_e( 'Name', 'zephyr-project-manager' ); ?>"/>
					<textarea id="zpm_quicktask_description" class="zpm_input" type="text" placeholder="<?php esc_html_e( 'Description', 'zephyr-project-manager' ); ?>"></textarea>
					<input id="zpm_quicktask_date" class="zpm_input" type="text" placeholder="<?php esc_html_e( 'Due Date', 'zephyr-project-manager' ); ?>" />

					<div id="zpm_quicktask_assignee">
						<select id="zpm_quicktask_select_assignee" class="zpm_dropdown">
							<option value="-1"><?php esc_html_e( 'Select Assignee', 'zephyr-project-manager' ); ?></option>
					...
					<div class="zpm_quicktask_actions">
						<button id="zpm_create_quicktask" class="zpm_button_outline"><?php esc_html_e( 'Save Task', 'zephyr-project-manager' ); ?></button>
					</div>
				</div>
			</div>
		...
		<div class="zpm_tab_pane zpm_tab_active" data-zpm-tab="1" id="zpm-project-modal-overview">
			...
			<span id="zpm_project_modal_description" class="zpm_project_overview_section">
				...
				<p class="zpm_description"><?php echo zpm_esc_html($project->description); ?></p>
			...
			<div class="zpm-project-preview__field">
				...
				<p><span class="zpm-project-preview__status-color <?php echo esc_attr($status['color']); ?>"></span><?php echo esc_html($status['status']); ?></p>
			</div>
		...
		<div class="zpm_tab_pane" data-zpm-tab="3" id="zpm-project-modal-discussion">
			...
			<?php if ( empty( $comments_html ) ) : ?>
				<p class="zpm-subtle-message zpm-no-comments-error"><?php esc_html_e( 'No discussion yet', 'zephyr-project-manager' ); ?></p>
			<?php endif; ?>
		</div>
	</div>

	<div class="zpm_modal_buttons">
		<a id="zpm-go-to-project-btn" class="zpm_button" href="<?php echo esc_url($url); ?>"><?php esc_html_e( 'Go to Project', 'zephyr-project-manager' ); ?></a>
	</div>