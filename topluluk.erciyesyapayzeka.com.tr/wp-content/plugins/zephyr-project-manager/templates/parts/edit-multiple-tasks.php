...
<div id="zpm-edit-multiple-tasks-modal" class="zpm-modal zpm-form zpm-modal-default" role="dialog" aria-modal="true" aria-hidden="true">
    <h5 class="zpm_modal_header"><?php esc_html_e('Edit Multiple Tasks', 'zephyr-project-manager'); ?></h5>
    <div class="zpm_modal_body">
        <div class="zpm_modal_content">
            ...
            <div class="zpm-bulk-task-edit--toggle-container active" data-edit-multiple-task-container>
                <div class="zpm-edit-multiple-task--header" data-edit-multiple-task-header>
                    ...
                    <label class="zpm_label" for="zpm-task-list-assignees"><?php esc_html_e('Assignees', 'zephyr-project-manager'); ?></label>
                </div>
                <div class="zpm-edit-multiple-task--setting" data-edit-multiple-task-setting>
                    <select data-edit-multiple-task-input="assignees" id="zpm-task-list-assignees" class="zpm-chosen zpm-chosen-input" multiple data-placeholder="<?php esc_html_e('Select Assignees', 'zephyr-project-manager'); ?>">
            ...
            <div class="zpm-bulk-task-edit--toggle-container" data-edit-multiple-task-container>
                <div class="zpm-edit-multiple-task--header" data-edit-multiple-task-header>
                    ...
                    <label class="zpm_label" for="zpm-task-list-start-date"><?php esc_html_e('Start Date', 'zephyr-project-manager'); ?></label>
                </div>
                <div class="zpm-edit-multiple-task--setting" data-edit-multiple-task-setting>
                    <input type="text" autocomplete="off" data-edit-multiple-task-input="startDate" class="zpm-form__field zpm-datepicker" placeholder="<?php esc_html_e('Start Date', 'zephyr-project-manager'); ?>" />
                </div>
            </div>
            ...
            <div class="zpm-bulk-task-edit--toggle-container" data-edit-multiple-task-container>
                <div class="zpm-edit-multiple-task--header" data-edit-multiple-task-header>
                    ...
                    <label class="zpm_label" for="zpm-task-list-due-date"><?php esc_html_e('Due Date', 'zephyr-project-manager'); ?></label>
                </div>
                <div class="zpm-edit-multiple-task--setting" data-edit-multiple-task-setting>
                    <input type="text" autocomplete="off" data-edit-multiple-task-input="dueDate" class="zpm-form__field zpm-datepicker" placeholder="<?php esc_html_e('Due Date', 'zephyr-project-manager'); ?>" />
                </div>
            </div>
            ...
            <div class="zpm-bulk-task-edit--toggle-container" data-edit-multiple-task-container>
                <div class="zpm-edit-multiple-task--header" data-edit-multiple-task-header>
                    ...
                    <label class="zpm_label" for="zpm-task-list-status"><?php esc_html_e('Status', 'zephyr-project-manager'); ?></label>
                </div>
                <div class="zpm-edit-multiple-task--setting" data-edit-multiple-task-setting>
                    <select data-edit-multiple-task-input="status" id="zpm-task-list-status" class="zpm-chosen zpm-chosen-input" data-placeholder="<?php esc_html_e('Select Assignees', 'zephyr-project-manager'); ?>">
                        <?php foreach ($statuses as $key => $status) : ?>
                            <option value="<?php echo esc_attr($key); ?>"><?php echo esc_html($status['name']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="zpm-bulk-task-edit--toggle-container" data-edit-multiple-task-container>
                <div class="zpm-edit-multiple-task--header" data-edit-multiple-task-header>
                    ...
                    <label class="zpm_label" for="zpm-task-list-priority"><?php esc_html_e('Priority', 'zephyr-project-manager'); ?></label>
                </div>
                <div class="zpm-edit-multiple-task--setting" data-edit-multiple-task-setting>
                    <select data-edit-multiple-task-input="priority" id="zpm-task-list-priority" class="zpm-chosen zpm-chosen-input" data-placeholder="<?php esc_html_e('Select Assignees', 'zephyr-project-manager'); ?>">
                        <?php foreach ($priorities as $key => $priority) : ?>
                            <option value="<?php echo esc_attr($key); ?>"><?php echo esc_html($priority['name']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
        ...
        <div class="zpm_modal_buttons">
            <button type="submit" class="zpm_button" data-update-multiple-tasks-button><?php esc_html_e('Update Selected Tasks', 'zephyr-project-manager'); ?></button>
        </div>
    </div>
</div>