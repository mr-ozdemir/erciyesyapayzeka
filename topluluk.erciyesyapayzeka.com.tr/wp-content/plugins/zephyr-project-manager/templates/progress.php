...
<main class="zpm_settings_wrap">
	...
	<div id="zpm_container">
		<h1 class="zpm_page_title"><?php esc_html_e( 'Progress', 'zephyr-project-manager' ); ?></h1>
		<div class="zpm_panel_container">
			<div class="zpm_body zpm_category_display">
				<div>
					<p class="zpm_instructions"><?php esc_html_e( 'Select a project to display the progress for.', 'zephyr-project-manager' ); ?></p>
