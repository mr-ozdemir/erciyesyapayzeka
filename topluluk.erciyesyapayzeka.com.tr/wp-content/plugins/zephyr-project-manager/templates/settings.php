		...
		<div class="zpm_body">
			<div class="zpm-tab-content">
				<div data-section="profile_settings" class="tab-pane active">
					...
					ob_start();
					?>
					<h3 class="zpm_h3 zpm_tab_title <?php echo esc_attr($action == 'profile' || $action == '' ? 'zpm_tab_selected' : '') ?>" data-zpm-tab-trigger="profile"><?php esc_html_e('Profile Settings', 'zephyr-project-manager') ?></h3>

					<?php if ($canAccessGeneralSettings) : ?>
						<h3 class="zpm_h3 zpm_tab_title <?php echo esc_attr($action == 'general' ? 'zpm_tab_selected' : '') ?>" data-zpm-tab-trigger="general"><?php esc_html_e('General Settings', 'zephyr-project-manager') ?></h3>
					<?php endif; ?>
					<?php
					$tabs = ob_get_clean();
					...
					?>
						<h3 class="zpm_h3 zpm_tab_title <?php echo esc_attr($action == $id ? 'zpm_tab_selected' : '') ?>" data-zpm-tab-trigger="<?php echo esc_attr($id); ?>"><?php echo esc_html($tab['title']); ?></h3>
					<?php
					}

					if ($canAccessAdvancedSettings) {
					?>
						<h3 class="zpm_h3 zpm_tab_title <?php echo esc_attr($action == 'tools' ? 'zpm_tab_selected' : '') ?>" data-zpm-tab-trigger="tools"><?php esc_html_e('Tools', 'zephyr-project-manager'); ?></h3>
						<h3 class="zpm_h3 zpm_tab_title <?php echo esc_attr($action == 'advanced' ? 'zpm_tab_selected' : '') ?>" data-zpm-tab-trigger="advanced"><?php esc_html_e('Advanced', 'zephyr-project-manager'); ?></h3>
					<?php
					}
					...
					<div class="zpm_tab_panel <?php echo $action == 'profile' || $action == '' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="profile">
						...
						<form id="zpm_profile_settings" method="post">
							<label class="zpm_label"><?php esc_html_e('Profile Picture', 'zephyr-project-manager'); ?></label>
							...
							<div class="zpm-form__group">
								<input type="text" name="zpm_settings_name" id="zpm_settings_name" class="zpm-form__field" placeholder="<?php esc_html_e('Name', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($settings_name); ?>">
								<label for="zpm_settings_name" class="zpm-form__label"><?php esc_html_e('Name', 'zephyr-project-manager'); ?></label>
							</div>

							<div class="zpm-form__group">
								<textarea type="text" name="zpm_settings_description" id="zpm_settings_description" class="zpm-form__field" placeholder="<?php esc_html_e('Description', 'zephyr-project-manager'); ?>"><?php echo zpm_esc_html($settings_description); ?></textarea>
								<label for="zpm_settings_description" class="zpm-form__label"><?php esc_html_e('Description', 'zephyr-project-manager'); ?></label>
							</div>

							<div class="zpm-form__group">
								<input type="text" name="zpm_settings_email" id="zpm_settings_email" class="zpm-form__field" placeholder="<?php esc_html_e('Email Address', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($settings_email); ?>">
								<label for="zpm_settings_email" class="zpm-form__label"><?php esc_html_e('Email Address', 'zephyr-project-manager'); ?></label>
							</div>

							<?php do_action('zpm_settings_fields'); ?>

							<label class="zpm_label"><?php esc_html_e('Hide WordPress Dashboard Widgets', 'zephyr-project-manager'); ?></label>
							...
							<label for="zpm-hide-dashboard-widgets" class="zpm-material-checkbox">
								...
								<span class="zpm-material-checkbox-label"><?php esc_html_e('Hidden', 'zephyr-project-manager'); ?></span>
							</label>

							<label class="zpm_label"><?php esc_html_e('Email Notifications', 'zephyr-project-manager'); ?></label>
							<label for="zpm_notify_activity" class="zpm-material-checkbox">
								...
								<span class="zpm-material-checkbox-label"><?php esc_html_e('All Activity', 'zephyr-project-manager'); ?></span>
							</label>
							...
							<label for="zpm_notify_tasks" class="zpm-material-checkbox">
								...
								<span class="zpm-material-checkbox-label"><?php esc_html_e('New Tasks', 'zephyr-project-manager'); ?></span>
							</label>
							...
							<label for="zpm_notify_task_assigned" class="zpm-material-checkbox">
								...
								<span class="zpm-material-checkbox-label"><?php esc_html_e('Task Assigned', 'zephyr-project-manager'); ?></span>
							</label>
							...
							<label for="zpm-email-notifications--new-project-tasks" class="zpm-material-checkbox">
								...
								<span class="zpm-material-checkbox-label"><?php esc_html_e('New Project Tasks', 'zephyr-project-manager'); ?></span>
							</label>
							...
							<label for="zpm_notify_updates" class="zpm-material-checkbox">
								...
								<span class="zpm-material-checkbox-label"><?php esc_html_e('Weekly Updates', 'zephyr-project-manager'); ?></span>
							</label>

							<?php wp_nonce_field('zpm_save_project_settings'); ?>

							<div id="zpm-profile-settings-buttons">
								<button type="submit" class="zpm_button" name="zpm_profile_settings" id="zpm_profile_settings"><?php esc_html_e('Save Settings', 'zephyr-project-manager'); ?></button>
							</div>
						</form>
					</div>
					...
					<?php if ($canAccessGeneralSettings) : ?>
						<div class="zpm_tab_panel <?php echo $action == 'general' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="general">
							...
							<form id="zpm_profile_settings" method="post">
								...
								<label class="zpm_label zpm_divider_label"><?php esc_html_e('General Settings', 'zephyr-project-manager') ?></label>

								<div class="zpm-form__group">
									<input type="text" name="zpm-settings__projects-per-page" id="zpm-settings__projects-per-page" class="zpm-form__field" placeholder="<?php esc_html_e('Projects Per Page', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($general_settings['projects_per_page']); ?>">
									<label for="zpm-settings__projects-per-page" class="zpm-form__label"><?php esc_html_e('Projects Per Page', 'zephyr-project-manager'); ?></label>
								</div>

								<div class="zpm-form__group">
									<input type="text" name="zpm-settings__tasks-per-page" id="zpm-settings__tasks-per-page" class="zpm-form__field" placeholder="<?php esc_html_e('Tasks Per Page', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($general_settings['tasks_per_page']); ?>">
									<label for="zpm-settings__tasks-per-page" class="zpm-form__label"><?php esc_html_e('Tasks Per Page', 'zephyr-project-manager'); ?></label>
								</div>

								<label class="zpm_label"><?php esc_html_e('Group Projects by Category', 'zephyr-project-manager'); ?></label>
								...
								<label for="zpm-settings__enable-category-grouping" class="zpm-material-checkbox">
									...
									<span class="zpm-material-checkbox-label"><?php esc_html_e('Enable grouping of projects by category', 'zephyr-project-manager'); ?></span>
								</label>

								<label class="zpm_label"><?php esc_html_e('Display Project ID', 'zephyr-project-manager'); ?></label>
								...
								<label for="zpm-settings-display-project-id" class="zpm-material-checkbox">
									...
									<span class="zpm-material-checkbox-label"><?php esc_html_e('Display Unique Project ID', 'zephyr-project-manager'); ?></span>
								</label>
								...
								<label for="zpm-settings-display-database-project-id" class="zpm-material-checkbox">
									...
									<span class="zpm-material-checkbox-label"><?php esc_html_e('Display Auto Increment Project ID', 'zephyr-project-manager'); ?></span>
								</label>
								...
								<div class="zpm-form-field-section">
									<label for="zpm-settings__display-task-id" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Display Task ID', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div class="zpm-form-field-section">
									<label for="direct_link_project" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Directly link to project', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div class="zpm-form-field-section">
									<label for="direct_link_task" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Directly link to task', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div class="zpm-form__group">
									<select id="zpm-settings-default-project-tab" name="zpm-settings-default-project-tab" class="zpm_input">
										<?php foreach ($projectTabs as $idx => $tab) : ?>
											<option value="<?php echo esc_attr($idx); ?>" <?php selected($general_settings['default_project_tab'], $idx); ?>><?php echo esc_html($tab); ?></option>
										<?php endforeach; ?>
									</select>
									<label for="zpm-settings-default-project-tab" class="zpm-form__label"><?php esc_html_e('Default Project Tab', 'zephyr-project-manager'); ?></label>
								</div>

								<label class="zpm_label zpm_divider_label"><?php esc_html_e('Email Settings', 'zephyr-project-manager') ?></label>

								<div class="zpm-form__group">
									<input type="text" name="zpm-settings-email-from-name" id="zpm-settings-email-from-name" class="zpm-form__field" placeholder="<?php esc_html_e('From Name', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($general_settings['email_from_name']); ?>">
									<label for="zpm-settings-email-from-name" class="zpm-form__label"><?php esc_html_e('From Name', 'zephyr-project-manager'); ?></label>
								</div>

								<div class="zpm-form__group">
									<input type="text" name="zpm-settings-email-from-email" id="zpm-settings-email-from-email" class="zpm-form__field" placeholder="<?php esc_html_e('From Email', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($general_settings['email_from_email']); ?>">
									<label for="zpm-settings-email-from-email" class="zpm-form__label"><?php esc_html_e('From Email', 'zephyr-project-manager'); ?></label>
								</div>
								...
								<div class="zpm-form-field-section">
									<label for="zpm-settings__override-default-emails" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Send emails to all users (not assigned users only)', 'zephyr-project-manager'); ?></span>
									</label>
								</div>

								<label class="zpm_label zpm_divider_label"><?php esc_html_e('Permissions & Capabilities', 'zephyr-project-manager') ?></label>

								<?php if (current_user_can('administrator')) : ?>
									<label class="zpm_label"><?php esc_html_e('Which Roles Can Access Zephyr Project Manager', 'zephyr-project-manager'); ?></label>
									<select id="zpm-access-roles" class="zpm_input zpm-chosen-multi zpm-multi-select" multiple name="zpm-access-roles[]">
										<?php foreach ($allRoles as $role => $data) : ?>
											...
											<option value=<?php echo esc_attr($role) ?> <?php echo in_array($role, $accessRoles) ? 'selected' : '' ?>><?php echo esc_html($data['name']); ?></option>
										<?php endforeach; ?>
									</select>
								<?php endif; ?>
								...
								<?php if (Utillities::is_admin()) : ?>
									...
									<label class="zpm_label"><?php esc_html_e('Who can complete tasks', 'zephyr-project-manager'); ?></label>
									<select class="zpm_input" name="zpm-settings__can-complete-tasks">
										<option value="0" <?php echo isset($general_settings['can_complete_tasks']) && $general_settings['can_complete_tasks'] == '0' ? 'selected' : ''; ?>><?php esc_html_e('Everyone', 'zephyr-project-manager'); ?></option>
										<option value="1" <?php echo isset($general_settings['can_complete_tasks']) && $general_settings['can_complete_tasks'] == '1' ? 'selected' : ''; ?>><?php esc_html_e('Only Assigned Users', 'zephyr-project-manager'); ?></option>
										<option value="2" <?php echo isset($general_settings['can_complete_tasks']) && $general_settings['can_complete_tasks'] == '2' ? 'selected' : ''; ?>><?php esc_html_e('Only Administrators & Managers', 'zephyr-project-manager'); ?></option>
										<option value="3" <?php echo isset($general_settings['can_complete_tasks']) && $general_settings['can_complete_tasks'] == '3' ? 'selected' : ''; ?>><?php esc_html_e('Nobody', 'zephyr-project-manager'); ?></option>
									</select>
								<?php endif; ?>
								...
								<div class="zpm-form-field-section">
									<label for="zpm_view_own_files" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Allow users to only view own files', 'zephyr-project-manager'); ?></span>
									</label>
								</div>

								<div class="zpm-form-field-section">
									<label for="zpm_auto_allow_new_users" class="zpm-material-checkbox">
										<input type="checkbox" id="zpm_auto_allow_new_users" name="zpm_auto_allow_new_users" class="zpm_toggle invisible" value="1" <?php echo isset($general_settings['auto_allow_new_users']) && $general_settings['auto_allow_new_users'] ? 'checked' : '';  ?>>
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Allow newly registered users access to Zephyr automatically', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div class="zpm-form-field-section">
									<label for="zpm-settings__view-members" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Allow users to view other members on the site', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div class="zpm-form-field-section">
									<label for="zpm-settings__extended-file-uploader" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Enable extended file uploader with external link input', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div class="zpm-form-field-section">
									<label for="zpm-settings__disable-files-globally" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Disable files globally', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<!-- <div class="zpm-form-field-section">
									<label for="zpm-view-assigned-categories-only" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Allow users to only view categories with projects they are members of', 'zephyr-project-manager'); ?></span>
									</label>
								</div> -->

								<label class="zpm_label"><?php esc_html_e('Default Assignee', 'zephyr-project-manager'); ?></label>
								<select class="zpm_input" name="zpm-settings__default-assignee">
									<option value="-1" <?php echo isset($general_settings['default_assignee']) && $general_settings['default_assignee'] == '-1' ? 'selected' : ''; ?>><?php esc_html_e('None', 'zephyr-project-manager'); ?></option>
									<option value="current" <?php selected($general_settings['default_assignee'], 'current'); ?>><?php esc_html_e('Current User', 'zephyr-project-manager'); ?></option>
								...
								<label class="zpm_label"><?php esc_html_e('Default Project', 'zephyr-project-manager'); ?></label>
								<select class="zpm_input" name="zpm-settings__default-project">
									<option value="-1" <?php echo isset($general_settings['default_project']) && $general_settings['default_project'] == '-1' ? 'selected' : ''; ?>><?php esc_html_e('None', 'zephyr-project-manager'); ?></option>
								...
								<label class="zpm_label"><?php esc_html_e('Default Status', 'zephyr-project-manager'); ?></label>
								<select class="zpm_input" name="zpm-settings__default-status">
									<option value="" <?php echo isset($general_settings['default_status']) && $general_settings['default_status'] == '' ? 'selected' : ''; ?>><?php esc_html_e('None', 'zephyr-project-manager'); ?></option>
									<?php foreach ($statuses as $slug => $status) : ?>
										<option value="<?php echo esc_attr($slug); ?>" <?php echo isset($general_settings['default_status']) && $general_settings['default_status'] == $slug ? 'selected' : ''; ?>><?php echo esc_html($status['name']); ?></option>
									<?php endforeach; ?>
								</select>
								...
								<div class="zpm-form-field-section">
									<label for="zpm-settings__use-current-dates-as-default" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Use current date as the default start and due dates', 'zephyr-project-manager'); ?></span>
									</label>
								</div>

								<?php do_action('zpm_permission_settings'); ?>

								<label class="zpm_label zpm_divider_label"><?php esc_html_e('Customization', 'zephyr-project-manager') ?></label>

								<label class="zpm_label" for="zpm_colorpicker_primary"><?php esc_html_e('Primary Color', 'zephyr-project-manager'); ?></label>
								...
								<label class="zpm_label" for="zpm_colorpicker_primary_dark"><?php esc_html_e('Primary Dark Color', 'zephyr-project-manager'); ?></label>
								...
								<label class="zpm_label" for="zpm_colorpicker_primary_light"><?php esc_html_e('Primary Light Color', 'zephyr-project-manager'); ?></label>
								...
								<label class="zpm_label zpm_divider_label"><?php esc_html_e('Dates & Calendar Settings', 'zephyr-project-manager') ?></label>

								<!-- First day of week -->
								<label class="zpm_label"><?php esc_html_e('Calendar First Day', 'zephyr-project-manager'); ?></label>
								...
								<!-- Date formats -->
								<label class="zpm_label"><?php esc_html_e('Date Format', 'zephyr-project-manager'); ?></label>
								...
								<label for="zpm-setting__show-time" class="zpm-material-checkbox">
									...
									<span class="zpm-material-checkbox-label"><?php esc_html_e('Show Time', 'zephyr-project-manager'); ?></span>
								</label>

								<!-- Calendar colors -->
								<label class="zpm_label"><?php esc_html_e('Calendar Task Colors', 'zephyr-project-manager'); ?></label>
								...
								<div class="zpm-mt-2">
									<label for="zpm-settings-show-calendar-due-date-only" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Show calendar due date only', 'zephyr-project-manager'); ?></span>
									</label>
								</div>

								<div class="zpm-mt-2">
									<label class="zpm_label" for="zpm-settings-calendar-text-color"><?php esc_html_e('Calendar Text Color', 'zephyr-project-manager'); ?></label>
								...
								<div class="zpm-mt-2">
									<label for="zpm-settings-ics-sync-enabled" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Enable public synced ICS file', 'zephyr-project-manager'); ?></span>
									</label>
								</div>

								<?php /* translators: File availability message. %s: File URL */ ?>
								<small><?php printf(esc_html('File will be available at %s', 'zephyr-project-manager'), '<a href="' . $icsUrl . '">' . $icsUrl . '</a>'); ?></small>

								<!-- Emails -->
								<label class="zpm_label zpm_divider_label"><?php esc_html_e('Email Settings', 'zephyr-project-manager') ?></label>
								<div class="zpm-form__group">
									<textarea name="zpm-settings__email-mentions-content" id="zpm-settings__email-mentions-content" class="zpm-form__field" placeholder="<?php esc_html_e('Mentions Email', 'zephyr-project-manager'); ?>" value="<?php echo esc_attr($general_settings['email_from_email']); ?>"><?php echo esc_textarea($general_settings['email_mentions_content']); ?></textarea>
									<label for="zpm-settings__email-mentions-content" class="zpm-form__label"><?php esc_html_e('Mentions Email', 'zephyr-project-manager'); ?></label>
								</div>

								<!-- Files -->
								<label class="zpm_label zpm_divider_label"><?php esc_html_e('File Settings', 'zephyr-project-manager') ?></label>
								<label class="zpm_label"><?php esc_html_e('File Icon', 'zephyr-project-manager'); ?></label>
								<div class="zpm-site-logo-container" data-file-container>
									...
									<label id="zpm-settings-file-icon-reset" class="zpm-file-upload-reset" data-file-reset><?php esc_html_e('Reset', 'zephyr-project-manager'); ?></label>
								</div>
								<label class="zpm_label"><?php esc_html_e('Folder Icon', 'zephyr-project-manager'); ?></label>
								<div class="zpm-site-logo-container" data-file-container>
									...
									<label id="zpm-settings-folder-icon-reset" class="zpm-file-upload-reset" data-file-reset><?php esc_html_e('Reset', 'zephyr-project-manager'); ?></label>
								</div>

								<label class="zpm_label zpm_divider_label"><?php esc_html_e('Task Settings', 'zephyr-project-manager') ?></label>
								<div>
									<label for="zpm-settings-hide-completed-tasks" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Hide completed tasks on My Tasks page', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div>
									<label for="zpm-settings-auto-unassign-on-project-remove" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Automatically unassign users from tasks when removed from the project', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div>
									<label for="zpm-settings-task-duration-enabled" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Enable the task "Duration" field', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div>
									<label for="zpm-settings-task-blocking-enabled" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Enable the blocking tasks feature', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<label class="zpm_label zpm_divider_label"><?php esc_html_e('Other Settings', 'zephyr-project-manager') ?></label>
								<div>
									<label for="zpm-settings__rest-api-disable-authentication" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Disable Authentication for REST API Requests', 'zephyr-project-manager'); ?></span>
									</label>
								</div>
								...
								<div>
									<label for="zpm-settings__enable-node" class="zpm-material-checkbox">
										...
										<span class="zpm-material-checkbox-label"><?php esc_html_e('Enable Node Server (For real-time updates)', 'zephyr-project-manager'); ?></span>
									</label>
								</div>

								<?php wp_nonce_field('zpm_save_general_settings'); ?>
								<button type="submit" class="zpm_button" name="zpm_save_general_settings" id="zpm_save_general_settings"><?php esc_html_e('Save Settings', 'zephyr-project-manager'); ?></button>
							</form>
						</div>
					<?php endif; ?>
					...
					<?php if ($canAccessAdvancedSettings) : ?>
						<div class="zpm_tab_panel <?php echo $action == 'tools' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="tools">
							...
							<form id="zpm_advanced_settings" method="post" enctype='multipart/form-data'>
								<button type="button" class="zpm_button" zpm-send-test-emails><?php esc_html_e("Send Test Emails", 'zephyr-project-manager'); ?></button>
								<button type="button" class="zpm_button" data-export-tasks-csv><?php esc_html_e("Export Tasks To CSV", 'zephyr-project-manager'); ?></button>
								<button type="button" class="zpm_button" data-export-projects-csv><?php esc_html_e("Export Projects To CSV", 'zephyr-project-manager'); ?></button>
						...
						<div class="zpm_tab_panel <?php echo $action == 'advanced' ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="advanced">
							...
							<form id="zpm_advanced_settings" method="post" enctype='multipart/form-data'>
								...
								<div class="zpm-form__group">
									<textarea type="text" name="zpm-settings__custom-css" id="zpm-settings__custom-css" class="zpm-form__field" placeholder="<?php esc_html_e('Custom CSS', 'zephyr-project-manager'); ?>"><?php echo esc_textarea($general_settings['custom_css']); ?></textarea>
									<label for="zpm-settings__custom-css" class="zpm-form__label"><?php esc_html_e('Custom CSS', 'zephyr-project-manager'); ?></label>
								</div>

								<?php if (current_user_can('administrator')) : ?>
									<button type="button" class="zpm_button zpm-button__red" id="zpm-delete-data__button" data-zpm-modal="zpm-delete-data__modal"><?php esc_html_e("DELETE all Zephyr Project Manager Data", 'zephyr-project-manager'); ?></button>
									<?php endif; ?>

									<?php wp_nonce_field('zpm_save_general_settings'); ?>
								<button type="submit" class="zpm_button" name="zpm-settings__advanced-submit"><?php esc_html_e('Save Settings', 'zephyr-project-manager'); ?></button>
							</form>
					...
					foreach ($customTabs as $id => $tab) {
					?>
						<div class="zpm_tab_panel <?php echo $action == $id ? 'zpm_tab_active' : ''; ?>" data-zpm-tab="<?php echo esc_attr($id); ?>">
